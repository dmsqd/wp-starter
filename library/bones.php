...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // ie-only style sheet
    wp_register_style( 'bones-ie-styles', get_stylesheet_directory_uri() . '/library/css/ie.css', array(), '' );
    ...
    wp_enqueue_style('bones-ie-styles');
    $wp_styles->add_data( 'bones-ie-styles', 'conditional', 'lt IE 9' ); // add conditional comments for ie.css
    /*
...
function bones_excerpt_more($more) {
	...
	return '...  <a href="'. get_permalink($post->ID) . '" title="'. __('Read', 'dmsqdtheme') . get_the_title($post->ID).'">'. __('Read more &raquo;', 'dmsqdtheme') .'</a>';
}
